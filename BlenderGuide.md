...
To keep things simple, do not try to scale/align the various meshes to each other. But if you do, make sure to remove the rotation/transformation/scale from the opjects before exporting. (Alt+G, Alt+R, Alt+S)
